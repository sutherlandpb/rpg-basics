...
button_x[4] = display_get_gui_width() - 3 * button_width;
...
button_x[8] = (display_get_gui_width() / 2) - (2 * button_width);
button_y[8] = button_y[4] + button_height;
button_x[9] =  (display_get_gui_width() / 2) + (2 * button_width);
button_y[9] = button_y[4] + button_height;
